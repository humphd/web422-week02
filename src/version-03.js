// Version 03 uses an IIFE and an Object interface see:

// Close a function over our "module"'s code, hiding the internal details.
// We will return an Object that gets exposed via a global variable, wordCount.
var myModule = (function(global) {
  ...
  // Export the charCount function on an Object that we return, to be attached
...
// Here we can call myModule.charCount() since it is exposed on the global, but not countChars().
