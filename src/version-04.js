// Version 04 uses a node.js style CommonJS module, see:
...
// We can load this module directly in node.js using `const { charCount } = require('./version-04.js');` and call call charCount()
// A browser can't use CommonJS natively, so we have to bundle it (see `bundle-version-04` script).
